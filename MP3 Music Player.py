...
root = Tk()
root.title("Enjoy Music!")
root.iconbitmap('E:/MP3/MP3 Music Player.ico')
...
main_frame = Frame(root, bg="AntiqueWhite1")
main_frame.pack(pady=30, padx=20)

# Create Playlist Box
playlist_box = Listbox(main_frame, width=70, bg="black", fg="yellow", selectbackground="green", selectforeground='yellow')
playlist_box.grid(row=0, column=0)

# Create volume slider frame
volume_frame = LabelFrame(main_frame, text="Volume", font=('Helvetica',10,'bold'))
...
back_btn_img = PhotoImage(file='E:/MP3/images/back50.png')
forward_btn_img = PhotoImage(file='E:/MP3/images/forward50.png')
play_btn_img = PhotoImage(file='E:/MP3/images/play50.png')
pause_btn_img = PhotoImage(file='E:/MP3/images/pause50.png')
stop_btn_img = PhotoImage(file='E:/MP3/images/stop50.png')
exit_btn_img = PhotoImage(file='E:/MP3/images/exit50.png')


# Create Button Frame
control_frame = Frame(main_frame, bg="AntiqueWhite1")
...
button_quit = Button(control_frame, image=exit_btn_img, borderwidth=0, command= root.quit)
...
button_quit.grid(row=0, column=5, padx=10)
